  ...
  return (
    <div className="WRPMT-Main-Div">
      <div className="WRPMT-Text">
        ...
        <p style={{ width: '80%', textAlign: 'center', margin: '0 auto', paddingTop: '0.5%' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Demikros, nisl sit amet ultricies lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet</p>
      </div>
